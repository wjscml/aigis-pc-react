...
export default class Login extends React.Component {
    ...
    render() {
        return (
            <div className="flex-container" id="login" style={{height: this.state.screenHeight+'px'}}>
                <div className="canvaszz" style={{height: this.state.screenHeight+'px'}}></div>
                <canvas id="canvas" style={{height: this.state.screenHeight+'px'}}></canvas>
                <div className="login-main">
                    <div className="login-top">
                        <div className="logo"><i className="icon-logo"></i></div>
                        <div className="name">埃癸斯风险管理系统</div>
                    </div>
                    {this.props.children}
                    <p className="copyright">©2018 aigis.leadfintech   京ICP备12019798号</p>
                </div>
