...
export default class Algorithm extends React.Component {
    ...
    componentDidMount () {
      document.title="策略详情 - Aigis - 埃癸斯风险控制系统"
    }
    getData = () => {
        let lchartsData = [
          {
            ...
            <div className="algorithm-detail">
                <div className="top-container">
                    <div className="info">
                        ...
                        <div className="item">
                            <p className="name">累计收益</p>
                            <p className="value">{this.state.charts.value1}%</p>
                        </div>
                        <div className="item">
                            <p className="name">年化收益</p>
                            <p className="value">{this.state.charts.value2}%</p>
                        </div>

                        </div>
                        <div className="info-bottom">
                        <div className="item">
                            <p className="value">{this.state.charts.value3}%</p>
                            <p className="name">最大回撤</p>
                        </div>
                        <div className="item">
                            <p className="value">{this.state.charts.data[0].time}</p>
                            <p className="name">开始时间</p>
                        </div>
                        <div className="item">
                            <p className="value">1,000,000</p>
                            <p className="name">初始资金</p>
                        </div>
                        </div>
                    </div>
                    <div className="style">
                        <h1 className="title">风格分析</h1>
